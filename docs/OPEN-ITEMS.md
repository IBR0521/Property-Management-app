...
| A7 | **Earned fees sit in the trust account until swept** | Moving them to operating is a bank transfer and nothing in the application records one. Older than the fix above — management fees have done the same since Phase 6 — and `book_vs_clients` names it as a warning every month: "fees you have earned and not yet moved to your operating account". |
